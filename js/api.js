...
const getBaseURL = () => {
    ...
    // For deployed environment - uses same origin for API calls
    // This requires a Node.js server to serve both frontend and API
    // Alternatively, set a specific API URL for serverless deployments
